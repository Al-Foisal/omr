    ...
    <div class="limiter">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="{{ route('admin.auth.storeResetPassword') }}" method="post">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" type="text" name="email" placeholder="Email" value="{{ old('email', $request->email) }}" autofocus required>
                    ...
                    <div class="text-center p-t-12">
                        <a class="txt2" href="{{ route('admin.auth.login') }}">
                            Login?
                        </a>
                    </div>
                </form>
